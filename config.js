...
module.exports = {
    ...
    SESSION: process.env.RDX_SESSION === undefined ? '' : process.env.RDX_SESSION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By RDX' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '917736771516@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? ' 𝐑𝐃𝐗 𝐕𝟐 ' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮⃝🕊️𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐈𝐍𝐆 𝐘𝐎𝐔𝐑 𝐒𝐎𝐍𝐆✮⃝🕊️' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮⃝🕊️✿𝐔𝐏𝐋𝐎𝐀𝐃𝐈𝐍𝐆 𝐘𝐎𝐔𝐑 𝐒𝐎𝐍𝐆✿✮⃝🕊️' : process.env.SONGU,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/xihfXRE.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ʀᴅx ʙᴏᴛ' : process.env.LOGO_NAME,
    ...
    SUPPORT: "917736771516-1634134075",
    SUPPORT2: "919605101516-1617736751",
    SUPPORT3: "919605101516-1621015274"
};
